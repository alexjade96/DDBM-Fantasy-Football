...
_DEFAULT_PLAYOFF_DIR = str(SEASON_DIR)
...
# scaffold.py (a CLI, now at data/seasons/scaffold.py); promoted here so the
# webapp can call them without shelling out. scaffold.py now imports these.
_gen_cache: dict = {}
...
def apply_playoffs(seasons: dict, playoff_dir: str = _DEFAULT_PLAYOFF_DIR,
...
def load_playoffs(playoff_dir: str = _DEFAULT_PLAYOFF_DIR, league_ids=None) -> dict:
