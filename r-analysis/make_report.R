...
#
#   Rscript r-analysis/make_report.R [league_id] [--season 2024] [--out file.html] [--all]
#
# Invoked by launch.py ("r report"); loads the package via pkgload and writes the
# report(s) to the repo root. Mirrors fantasy-football-4-fun/make_report.py.
