# Self-contained season report (mirrors fantasy-football-4-fun/sleepermetrics/report.py) -----
#
...
# CSS + template: byte-identical to fantasy-football-4-fun/sleepermetrics/report.py so the two
