...
#
# Defaults: port 8100, the DDBM league. Exposes playoffs/ so the Playoffs tab
...
cat("Playoff brackets: ", paste(names(sl_playoff_configs("playoffs")), collapse = ", "),
    "\nPress Ctrl+C to stop.\n\n", sep = "")

sl_dashboard(league_id = league, playoffs = "playoffs",
