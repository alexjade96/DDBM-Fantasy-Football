...
#
#   Rscript tools/dev/render_examples.R [league_id]
#
...
# correct. Output: r-analysis/data/results/examples/r/ (gitignored build
# artifacts).
...
OUT <- "r-analysis/data/results/examples/r"
...
cat("Loading league...\n")
ss <- sl_apply_playoffs(sl_seasons(league), sl_season_dir())
latest <- ss[[length(ss)]]
